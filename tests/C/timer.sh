...
mpirun -n 1 $DIR/test_writer DATASPACES 1 2 1 1 16384 16384 1 1 > $DIR/writer_$CONF_DIMS.log 2>&1 &
mpirun -n 1 $DIR/test_reader DATASPACES 1 2 1 1 16384 16384 1 2 > $DIR/reader_$CONF_DIMS.log 2>&1 &
#mpirun -n 1 $DIR/test_writer DATASPACES 1 2 1 1 4096 4096 1 1 > $DIR/writer_$CONF_DIMS.log 2>&1 &
#mpirun -n 1 $DIR/test_reader DATASPACES 1 2 1 1 4096 4096 1 2 > $DIR/reader_$CONF_DIMS.log 2>&1 &
...
#mpirun -n 1 $DIR/test_writer DATASPACES 1 2 1 1 8192 8192 1 1 > $DIR/writer_$CONF_DIMS.log 2>&1 &
#mpirun -n 1 $DIR/test_reader DATASPACES 1 2 1 1 8192 8192 1 2 > $DIR/reader_$CONF_DIMS.log 2>&1 &
wait
