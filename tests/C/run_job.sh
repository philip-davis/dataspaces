...
mpirun -n 4 $DIR/test_writer DATASPACES 4 2 4 1 256 1024 2 1 -d > $DIR/writer_$CONF_DIMS.log 2>&1 &
mpirun -n 1 $DIR/test_reader DATASPACES 1 2 1 1 1024 1024 2 2 -d > $DIR/reader_$CONF_DIMS.log 2>&1 &
wait
