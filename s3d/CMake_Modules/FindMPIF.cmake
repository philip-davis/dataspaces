...
# Modified to look for fortan interface 
...
elseif (MPI_COMPILE_CMDLINE)
  ...
  set(MPI_LIBRARIES)
  message("mpi libnames:" ${MPI_LIBNAMES})
  message("mpi linkpath:" ${MPI_LINK_PATH})
  foreach(LIB ${MPI_LIBNAMES})
    string(REGEX REPLACE "^-l" "" LIB ${LIB})
    set(MPI_LIB "MPI_LIB-NOTFOUND" CACHE FILEPATH "Cleared" FORCE)
    find_library(MPI_LIB ${LIB} PATHS "/usr/lib64" ${MPI_LINK_PATH} NO_DEFAULT_PATH)
    if (MPI_LIB)
