...
if( ADIOS_INCLUDE_DIR AND ADIOS_LIBRARIES )
    ...
    if (NOT "$ENV{ADIOS_FLIB}" STREQUAL "")
        _ADIOS_parse_module_line( $ENV{ADIOS_FLIB} 
        ADIOS_INCLUDE_FLAGS
        ADIOS_LIBRARY_DIRS
        ADIOS_LIBRARY_NAMES
        )
    else (NOT "$ENV{ADIOS_FLIB}" STREQUAL "")
        set( ADIOS_LIBRARY_NAMES "adiosf" ) 
    endif(NOT "$ENV{ADIOS_FLIB}" STREQUAL "")

    if(NOT "$ENV{ADIOS_INC}" STREQUAL "")
        _ADIOS_parse_module_line( $ENV{ADIOS_INC} 
        ADIOS_INCLUDE_FLAGS
        ADIOS_LIBRARY_DIRS
        ADIOS_LIBRARY_NAMES
        )
    endif(NOT "$ENV{ADIOS_INC}" STREQUAL "")

    if(NOT "$ENV{ADIOSREAD_FLIB}" STREQUAL "")
        ...
        set( ADIOS_LIBRARY_NAMES ${ADIOS_LIBRARY_NAMES} "adiosreadf" ) 
    endif(NOT "$ENV{ADIOSREAD_FLIB}" STREQUAL "")
...
IF(NOT "${ADIOS_LIBRARIES}" STREQUAL "")
    list( APPEND ${ADIOS_LIBRARIES}  )
else( )
    SET( ADIOS_FOUND FALSE )
ENDIF(NOT "${ADIOS_LIBRARIES}" STREQUAL "")
