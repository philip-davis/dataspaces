...
! richardson, based on the premix_drvd_m by sankaran. Most of the routines here
! are duplicates of those in premix_drvd. The goal is to move the parts of 
! premix_drvd and isosurf which are used in the tracer_m transport at run time
! in here and remove them from /f90/post/. 
...
!----------------------------------------
! Oxygen is species #4
! Unburnt YO2 is 0.223855. Burnt YO2 is 0.066943  (from clookup.in)   !phi=0.7
