...
!=========================================================================================
  ...
  real function mixEnth( ys, temp )
    ...
    if(temp > temp_hibound .or. temp < temp_lobound ) then
       write(*,*)'mixEnth T is out of range!',temp,temp_lobound,temp_hibound
       stop
    endif
...
!=========================================================================================
  ...
  real function mixCp( ys, temp )
    ...
    if(temp > temp_hibound .or. temp < temp_lobound ) then
       write(*,*)' mixCp T is out of range!',temp,temp_lobound,temp_hibound
       stop
    endif
...
! any changes to this routine must also be done to mixenth and specenth_all
  real function specEnth(i_sp,temp)
    ...
    if(temp > temp_hibound .or. temp < temp_lobound ) then
       write(*,*)' specEnth T is out of range!',temp,temp_lobound,temp_hibound
       stop
    endif
...
!=========================================================================================
  ...
  if(temp > temp_hibound .or. temp < temp_lobound ) then
     write(*,*)' specEnth_all T is out of range!',temp,temp_lobound,temp_hibound
     stop
  endif
...
!=========================================================================================
  ...
  if(temp > temp_hibound .or. temp < temp_lobound ) then
     write(*,*)' gibbsEnrg_all T is out of range!',temp,temp_lobound,temp_hibound
     stop
  endif
...
!=========================================================================================
  ...
  real function specCp(i_sp,temp)
    ...
    if(temp > temp_hibound .or. temp < temp_lobound ) then
       write(*,*)'specCP T is out of range!',temp,temp_lobound,temp_hibound
       stop
    endif
