...
C     (14-group model for mixture-averaged diffusion)
C
C     Developed by:
C
C       Tianfeng Lu
...
C
      ...
      DIMENSION X(31), Y(31), WT(31), XXWT(31)
...
C
      ...
      XG(  5) = +X(  7) 
      XG(  6) = +X(  8) 
      XG(  7) = +X(  9) +X( 15) +X( 16) +X( 17) +X( 30) +X( 31)
      XG(  8) = +X( 10) 
      XG(  9) = +X( 11) +X( 13) 
      XG( 10) = +X( 12) +X( 14) 
      XG( 11) = +X( 18) 
...
C
      ...
      D( 31) = (1.D0-Y(31))/(QG(7)-X(31)/DG(7,7))/PA
C
      RETURN
      END
C----------------------------------------------------------------------C
