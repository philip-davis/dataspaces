...
C      use thermchem_m, only: gibbsEnrg_all_dimT
...
C      call gibbsEnrg_all_dimT(tc,cgspl)
...
C      cspl(1:ns) = y(1:ns)*molwt_c(1:ns)
C      rc = p*or0tc/sum(cspl(1:ns))
C      cspl(1:ns) = rc*cspl(1:ns)
...
c  16)  H2O2 (+M) <=> 2 OH (+M) 
     ...
     &  5.0d-001 * exp(-9.999999999999999d-031 * tc))
      flogpr = log10(pr) - 0.4 - 0.67 * fcent
      fdenom = 0.75 - 1.27 * fcent - 0.14 * flogpr
      fquan = flogpr / fdenom
      fquan = fcent / (1.0 + fquan * fquan)
...
c  1. H2
      wspl(NC_H2) = -ropl(2)-ropl(3)-ropl(5)+ropl(10)+ropl(18)
c  2. O2
...
c  6. H
     ...
     &  -ropl(9)-ropl(10)-ropl(11)-ropl(17)-ropl(18)
c  7. HO2
      wspl(NC_HO2) = ropl(9)-ropl(10)-ropl(11)-ropl(12)-ropl(13)
     &  -2.0*ropl(14)+ropl(18)+ropl(19)+ropl(20)
c  8. H2O2
