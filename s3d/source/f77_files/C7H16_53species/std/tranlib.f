...
C
      ...
      DIMENSION X(53), Y(53), WT(53), XXWT(53)
...
C
      ...
      XG(  2) = +X(  2) 
      XG(  3) = +X(  3) +X(  5) 
      XG(  4) = +X(  4) +X(  7) +X( 11) +X( 12) +X( 52) +X( 53)  
      XG(  5) = +X(  6) 
      XG(  6) = +X(  9) +X( 10) 
      XG(  7) = +X( 14) +X( 16) 
      XG(  8) = +X( 15) +X( 17) +X( 18) 
...
C
      ...
      D( 53) = (1.D0-Y(53))/(QG(4)-X(53)/DG(4,4))/PA
      D( 52) = D( 53)  ! set the transported mixture fraction equal to N2 diffusivity for now,
                       ! we will set it equal to alpha later in...
C
      RETURN
      END
C----------------------------------------------------------------------C
