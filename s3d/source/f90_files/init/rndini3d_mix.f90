...
subroutine rndini3d_mix( seed, ke, xim, xir, io, mixfr)
!
...
!----------------------------------------------------------------------------------------
  call scalar_3d(xmin,xmax,ymin,ymax,zmin,zmax,x,seed,mixfr,io,C_spect,ke)
!----------------------------------------------------------------------------------------
...
!         mixfr(i,j) = 0.5 * (1+tanh((mixfr(i,j)-0.5)))
  ...
  return
  end subroutine rndini3d_mix

!----------------------------------------------------------------------
! Scalar generation for 3D
subroutine scalar_3d(xmin, xmax, ymin,ymax,zmin,zmax,xx,iseed,mixfr,io,C_spect,ke)
